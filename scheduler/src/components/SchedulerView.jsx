import {
  ...
  TimelineMonth, TimelineYear, Resize, DragAndDrop, Inject
} from '@syncfusion/ej2-react-schedule';

const SchedulerView = ({ count }) => {
  ...
  const eventSettings = { dataSource: generateStaticEvents(new Date(2025, 4, 1), count, 12) };
    ...
    >
      <ResourcesDirective>
        <ResourceDirective
          ...
          name='Resources'
          allowMultiple={true}
          dataSource={generateResourceData(1, 100, 'Resource')}
          textField='Text'
          idField='Id'
          colorField='Color'
        />
